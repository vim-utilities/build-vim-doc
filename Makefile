...
# Install/Uninstall make script for vim-utilities/build-vim-doc
...
completion: ## Builds tab completion Bash configuration file for build-vim-doc
	"help-to-complete" --executable "$(ROOT_DIRECTORY_PATH)/build-vim-doc" --completion-dir "$(ROOT_DIRECTORY_PATH)/bash-completion" --clobber

link-completion: SHELL := /bin/bash
link-completion: ## Links tab completion  Bash configuration file for build-vim-doc
